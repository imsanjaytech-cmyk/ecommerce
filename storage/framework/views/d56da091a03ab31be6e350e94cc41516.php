...
<?php $__env->startSection('breadcrumb', 'Home / Products'); ?>
...
<div class="row g-3 mb-4">
    <div class="col-6 col-md-3">
        <div class="card-w" style="text-align:center;padding:16px 12px;">
            <div id="stat-total" style="font-size:22px;font-weight:800;color:var(--dark);"><?php echo e($stats['total']); ?></div>
    ...
    <div class="col-6 col-md-3">
        <div class="card-w" style="text-align:center;padding:16px 12px;border-top:3px solid #1f9c4a;">
            <div id="stat-in-stock" style="font-size:22px;font-weight:800;color:#1f9c4a;"><?php echo e($stats['in_stock']); ?></div>
    ...
    <div class="col-6 col-md-3">
        <div class="card-w" style="text-align:center;padding:16px 12px;border-top:3px solid #d97706;">
            <div id="stat-low-stock" style="font-size:22px;font-weight:800;color:#d97706;"><?php echo e($stats['low_stock']); ?></div>
    ...
    <div class="col-6 col-md-3">
        <div class="card-w" style="text-align:center;padding:16px 12px;border-top:3px solid var(--danger);">
            <div id="stat-out-of-stock" style="font-size:22px;font-weight:800;color:var(--danger);"><?php echo e($stats['out_of_stock']); ?></div>
...
window.PROD = {
    routes: {
        list:        '<?php echo e(route("admin.products.list")); ?>',
        store:       '<?php echo e(route("admin.products.store")); ?>',
        stats:       '<?php echo e(route("admin.products.stats")); ?>',
        show:        id => `/admin/products/${id}`,
        update:      id => `/admin/products/${id}`,
        destroy:     id => `/admin/products/${id}`,
        bulkDelete:  '<?php echo e(route("admin.products.bulk-delete")); ?>',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.adminlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\SanjayS\ecommerce\resources\views/admin/products.blade.php ENDPATH**/ ?>