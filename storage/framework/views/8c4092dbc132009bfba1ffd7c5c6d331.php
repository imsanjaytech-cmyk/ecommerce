...
<?php $__env->startSection('breadcrumb', 'Home / Reports'); ?>
...
<div class="row g-3 mb-4">
    ...
    <div class="col-md-3 col-sm-6">
        <div class="stat-card">
            <div class="stat-icon <?php echo e($k['si']); ?>"><i class="bi <?php echo e($k['icon']); ?>"></i></div>
            <div class="stat-label"><?php echo e($k['label']); ?></div>
            <div class="stat-value"><?php echo e($k['val']); ?></div>
            <div class="stat-change <?php echo e($k['up']?'ch-up':'ch-down'); ?>">
                <i class="bi <?php echo e($k['up']?'bi-arrow-up-right':'bi-arrow-down-right'); ?>"></i> <?php echo e($k['change']); ?>
...
<div class="card-w">
    ...
    <table class="tbl">
        ...
        <tr>
            <td style="font-weight:600;"><?php echo e($m['m']); ?></td>
            <td><?php echo e($m['o']); ?></td>
            <td style="font-weight:700;color:#1f9c4a;"><?php echo e($m['r']); ?></td>
            <td style="color:var(--danger);"><?php echo e($m['e']); ?></td>
            <td style="font-weight:700;color:var(--dark);"><?php echo e($m['p']); ?></td>
            <td style="font-weight:700;color:<?php echo e($m['up']?'#1f9c4a':'var(--danger)'); ?>;"><?php echo e($m['g']); ?></td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
    </table>
...
<?php echo $__env->make('layouts.adminlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\SanjayS\ecommerce\resources\views/admin/reports.blade.php ENDPATH**/ ?>