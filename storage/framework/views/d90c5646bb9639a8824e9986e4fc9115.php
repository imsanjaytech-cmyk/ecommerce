...
<?php $__env->startSection('breadcrumb', 'Home / Settings'); ?>
...
<div class="row g-4">
    ...
    <div class="col-md-3">
        <div class="card-w" style="padding:10px;">
            ...
            <a href="#" class="nav-link-item <?php echo e(isset($t['active'])?'active':''); ?>" style="margin-bottom:2px;">
                <i class="bi <?php echo e($t['icon']); ?>"></i> <?php echo e($t['label']); ?>
    ...
    <div class="col-md-9">
        ...
        <div class="card-w">
            ...
            ?>
            <?php $__currentLoopData = $toggles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div style="display:flex;align-items:center;justify-content:space-between;padding:14px 0;<?php echo e($i < count($toggles)-1 ? 'border-bottom:1px solid var(--border-col);':''); ?>">
                <div>
                    <div style="font-size:13.5px;font-weight:600;color:var(--dark);"><?php echo e($t['label']); ?></div>
                    <div style="font-size:12px;color:var(--text-muted);margin-top:2px;"><?php echo e($t['sub']); ?></div>
                </div>
                <div class="form-check form-switch mb-0" style="padding-left:0;">
                    <input class="form-check-input" type="checkbox" style="width:42px;height:22px;cursor:pointer;margin-left:0;" <?php echo e($t['on']?'checked':''); ?>>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
...
<?php echo $__env->make('layouts.adminlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\SanjayS\ecommerce\resources\views/admin/settings.blade.php ENDPATH**/ ?>