...
<head>
    ...
    <title>Admin — <?php echo $__env->yieldContent('page-title','Dashboard'); ?></title>
...
<body>
    ...
    <aside class="sidebar" id="adminSidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="<?php echo e(route('admin.orders')); ?>" class="nav-link-item <?php echo e(request()->routeIs('admin.orders') ? 'active' : ''); ?>">
                <i class="bi bi-bag-check-fill"></i> Orders
                <span class="nav-badge">12</span>
            </a>
            <a href="<?php echo e(route('admin.products')); ?>" class="nav-link-item <?php echo e(request()->routeIs('admin.products') ? 'active' : ''); ?>">
                <i class="bi bi-box-seam-fill"></i> Products
            </a>
            <a href="<?php echo e(route('admin.categories')); ?>" class="nav-link-item <?php echo e(request()->routeIs('admin.categories') ? 'active' : ''); ?>">
                <i class="bi bi-tags-fill"></i> Categories
            </a>
            <a href="<?php echo e(route('admin.customers')); ?>" class="nav-link-item <?php echo e(request()->routeIs('admin.customers') ? 'active' : ''); ?>">
                <i class="bi bi-people-fill"></i> Customers
            </a>

            <div class="nav-group-label">Analytics</div>
            <a href="<?php echo e(route('admin.reports')); ?>" class="nav-link-item <?php echo e(request()->routeIs('admin.reports') ? 'active' : ''); ?>">
                <i class="bi bi-bar-chart-line-fill"></i> Reports
            </a>

            <div class="nav-group-label">System</div>
            <a href="<?php echo e(route('admin.settings')); ?>" class="nav-link-item <?php echo e(request()->routeIs('admin.settings') ? 'active' : ''); ?>">
        ...
        <div class="sidebar-footer">
            <div class="admin-card">
                ...
                <div>
                    <div class="admin-nm"><?php echo e(auth()->user()->name ?? 'Admin User'); ?></div>
        ...
        <header class="topbar">
            <div class="topbar-left">
                ...
                <div class="topbar-title-wrap">
                    ...
                    <div class="topbar-bc"><?php echo $__env->yieldContent('breadcrumb','Home / Dashboard'); ?></div>
                </div>
            </div>
    ...
    <?php echo $__env->yieldPushContent('page-data'); ?>
    <script src="<?php echo e(asset('js/chart.js')); ?>"></script>
    <?php echo $__env->yieldPushContent('scripts'); ?>
</body>

</html><?php /**PATH C:\Users\SanjayS\ecommerce\resources\views/layouts/adminlayout.blade.php ENDPATH**/ ?>