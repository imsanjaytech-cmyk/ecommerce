...
<head>
    ...
    <style>
        :root {
            ...
            --pink-soft: #e8f0fa;
            --pink-mid: #c5d9f0;
            --pink-border: rgba(37, 88, 160, 0.15);
            --shadow-pink: 0 8px 25px rgba(37, 88, 160, 0.2);
            --dark: #1a1a1a;
            --light: #f8f9fa;
            --gray: #6c757d;
            --success: #28a745;
        ...
        *::after {
        ...
        .si-green {
            background: linear-gradient(135deg, #e8f8ee, #d1f1dc);
            color: #1f9c4a;
        }
    ...
    <aside class="sidebar" id="adminSidebar">
        <div class="sidebar-brand">
            <img src="{{ asset('images/logo2.png') }}"
                alt="Shana's Signature"
                style="height:38px; width:auto; object-fit:contain; flex-shrink:0;">
            <div>
                <div class="brand-name">Shana's Signature</div>
